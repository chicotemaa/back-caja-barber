...
export interface ApiDepositoDeposito extends Schema.CollectionType {
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    disponibilidad: Attribute.Boolean & Attribute.DefaultTo<true>;
    vencimiento: Attribute.Date;
    descripcion: Attribute.Text;
    umbralReorden: Attribute.Integer;
    marca: Attribute.Relation<
      'api::producto.producto',
      'manyToOne',
      'api::marca.marca'
    >;
    deposito: Attribute.Relation<
      'api::producto.producto',
      'manyToOne',
      'api::deposito.deposito'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::deposito.deposito': ApiDepositoDeposito;
